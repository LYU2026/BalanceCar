...
#define CPU_EXT_CLK_HZ              0x04C4B400UL /* Value of the main clock frequency (crystal or external clock) in Hz */
#define CPU_INT_CLK_HZ              0x007A1200UL /* Value of the internal oscillator clock frequency in Hz */

#define CPU_TICK_NS                 0x0CU /* CPU tick is a unit derived from the frequency of external clock source. If no external clock is enabled or available it is derived from the value of internal clock source. The value of this constant represents period of the clock source in ns. */

#define CPU_FAMILY_MCF                 /* Specification of the core type of the selected cpu */
#define CPU_DERIVATIVE_MCF52255_100_LQFP /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MCF52255CAF80      /* Part number of the selected cpu */
...
#define Cpu_EnableInt()  __EI(0)       /* Enable all maskable interrupts */
/*
** ===================================================================
